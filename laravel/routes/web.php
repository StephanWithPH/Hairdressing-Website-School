...
Route::get('/agenda/edit/{id}', [App\Http\Controllers\AppointmentsController::class, 'loadEditAppointmentPageAdmin'])->name('editappointmentadmin')->middleware(['auth']);
Route::post('/agenda/submit', [App\Http\Controllers\AppointmentsController::class, 'submitAppointmentAdmin'])->name('submitappointmentadmin')->middleware(['auth']);
Route::get('/agenda/cancel/{id}', [App\Http\Controllers\AppointmentsController::class, 'deleteAppointment'])->name('deleteappointment')->middleware(['auth']);
