    ...
    public function run()
    {
        ...
        $treatments = [
            [
                ...
                "price" => "47.5",
                "image" => asset('img/krullenknippen.jpg'),
            ],
            [
            ...
            [
                ...
                "price" => "15",
                "image" => asset('img/skinanalysis.jpg'),
            ],
            [
