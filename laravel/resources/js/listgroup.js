    ...
    SelectList.prototype.createListGroup = function() {
        ...
        $select.find('option').each(function (i, item) {
            ...
            var $new = $('<a>')
                        ...
                        .html('<span class="font-weight-bold">' + $item.html() + '</span>' + '<span class="float-right font-weight-bold">&euro;' + $item.attr('data-price') + '</span>' + '<p class="mt-1">' + $item.attr('data-description') + '</p>');
