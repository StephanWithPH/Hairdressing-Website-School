...
<body>
    <div id="app">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}">{{ __('Agenda') }}</a>
                            </li>
                            @if(\Illuminate\Support\Facades\Auth::user()->role->identifier == 'owner')
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('login') }}">{{ __('Medewerkers') }}</a>
                                </li>
                                <li class="nav-item">
        ...
        <main @guest style="
            background-image: url('{{ asset('img/authentication-background.jpg') }}');
            background-size: cover;
            background-repeat: no-repeat;
            background-position: center;" @endguest @auth class="py-4" @endauth>
